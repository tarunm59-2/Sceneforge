    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (e.key === 'Escape') {
        ...
        if (!appUrl && typeof window !== 'undefined') {
          const win = window as unknown as { env?: { NEXT_PUBLIC_APP_URL?: string }, __NEXT_DATA__?: { env?: { NEXT_PUBLIC_APP_URL?: string } } };
          appUrl = win.env?.NEXT_PUBLIC_APP_URL || win.__NEXT_DATA__?.env?.NEXT_PUBLIC_APP_URL;
        }
        if (!appUrl) {
